...
class Invitation(models.Model):
    ...
    to_user = models.ForeignKey(User, related_name="invitations_received", verbose_name="User to invite",help_text="Please seelct the user you want to play a game with.",on_delete=models.CASCADE)
